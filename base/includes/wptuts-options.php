...
function wptuts_options_enqueue_scripts() {
	wp_register_script( 'wptuts-upload', get_template_directory_uri() .'/js/wptuts-upload.js', array('jquery','media-upload','thickbox') );	
...
//FUNZIONE CHE SI OCCUPA DI STAMPARE L'IMMAGINE SE SELEZIONATA
...
//FUNZIONE CHE SI OCCUPA DI SCRIVERE UN TESTO
...
//FUNZIONE CHE SI OCCUPA DI GENERARE I BOTTONI UPLOAD
